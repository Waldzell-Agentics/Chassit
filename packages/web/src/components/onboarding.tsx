    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          <div className="p-5 rounded-lg bg-[#FFD9E1]"
            style={{
              background:
          ...
          >
            <div className="flex items-center mb-6">
              <SparklesIcon size={24} className="text-ai-btn" />
            </div>
            <h3 className="text-ai-btn font-medium mt-3">AI notebooks</h3>
            <p className="text-ai-btn mt-2">Generate TypeScript notebooks from natural language ideas</p>
          </div>
          ...
          <div className="border p-5 rounded-lg">
            ...
            <h3 className="text-primary font-medium mt-3">Interactive coding</h3>
            <p className="text-primary mt-2">Run and iterate on code cells instantly without setup</p>
          </div>
        </div>
      </div>
