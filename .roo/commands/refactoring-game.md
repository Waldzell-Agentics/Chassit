...
- `confidence_threshold` (optional): Quality threshold 0-1 (default: 0.97)
...
# Optional: Sandbox smoke test of refactor in isolation (E2B)
# See: ./sandbox-testing-game.md
# /sandbox-testing-game "<repo-or-path>" "" "npm test" "run a minimal flow that touches the refactored code" 600000
